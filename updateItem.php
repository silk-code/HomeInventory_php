    ...
    <body>
        ...
        if($continue){
            ...
            if($continue){
                ...
                echo "<form action='verifyUpdateItem.php' method='post'>";
                    ...
                    echo "Amount <input type='text' name='amount' value='".$_POST['qty']."'/><br>";
                    ...
                    echo "Notes <textarea name='note' rows='10' cols='60' wrap='virtual' value='".$_POST['note']."'>";
                        echo"</textarea><br>";
                    echo "<input type='hidden' name='itemID' value=".$_POST['itemID'].">";
                    echo "<input type='submit' name='updateItem' value='Go'><br>";
                echo "</form>";
                $mysqli -> close();
            }
        }
